//
//  XCUserNoResponsibilityCaseViewController.m
//  testApp
//
...
#import "XCUserNoResponsibilityCaseViewController.h"
#import "XCUserNoResponsibilityCaseDetailViewController.h"
#import "XCUserCaseListModel.h"
#import "XCUserCaseDetailModel.h"
#import <YYModel.h>
#define kcaseType @"无责事故案件"
@interface XCUserNoResponsibilityCaseViewController ()

@end

@implementation XCUserNoResponsibilityCaseViewController
    ...
    [RequestAPI getThreeCaseApply:param header:[UserInfoManager shareInstance].ticketID success:^(id response) {
        ...
        if (response[@"data"]) {
            ...
            if(isUsable(dataInfo, [NSDictionary class])) {
                ...
                XCUserNoResponsibilityCaseDetailViewController *injuryCaseDetailVC = [[XCUserNoResponsibilityCaseDetailViewController alloc] initWithTitle:self.navTitle];
