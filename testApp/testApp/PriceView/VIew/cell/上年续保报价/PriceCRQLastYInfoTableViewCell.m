...
- (void)layoutSubviews{
    ...
    self.labelName.frame = CGRectMake(30 * ViewRateBaseOnIP6, 15 * ViewRateBaseOnIP6, 300 * ViewRateBaseOnIP6, 30 * ViewRateBaseOnIP6);
    ...
    self.labelNum.frame = CGRectMake(200 * ViewRateBaseOnIP6, 17 * ViewRateBaseOnIP6, SCREEN_WIDTH - 230 * ViewRateBaseOnIP6, 26 * ViewRateBaseOnIP6);
    ...
    self.labelInfo.frame = CGRectMake(210 * ViewRateBaseOnIP6, 10 * ViewRateBaseOnIP6, 160 * ViewRateBaseOnIP6, 40 * ViewRateBaseOnIP6);
